<template>
  <el-container class="panel-container">
    <el-tabs v-model="activeTab" style="height: 100%; overflow: hidden" class="w-full">
      ...
      <el-tab-pane :label="i18nt('designer.hint.dsSetting')" name="3">
        <DsSetting :designer="designer" />
      </el-tab-pane>
    </el-tabs>
...
<script>
  ...
  import DsSetting from './ds-setting.vue'
